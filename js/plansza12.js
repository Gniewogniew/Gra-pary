...
function loadHighscore() {
    if (localStorage.getItem(".localstorage12")) {
        $savedScore.html(localStorage.getItem(".localstorage12"));
    }
}
...
function flipClick() {
    ...
    $card.find('.front').click(function() {
        ...
        if (first_card == secn_card) {
            ...
            total++;
            if (total == 12) {
// po znalezieniu wszystkich 12 par zatrzymanie czasu //
                stop_time = true;
...
//zapisz wynik w highscore//
    localStorage.setItem(".localstorage12", $savedScore.html());
